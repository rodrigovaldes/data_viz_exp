...
Does the correct oflabeling of the charts affect perception of the proportions in them?
...
All in all, waffle charts allow for greater accuracy than pie charts. All throught the range of questions, they consistently outperformed the pie charts. However, the failure of the timing variable to work as intended might have had some effect which we could not observe. Thus, waffle charts emerge as clear winners on the atribute of functionality. As for beauty, it might be argued that people might prefer pie charts simply because they are used to them, but there is no reason for which waffle charts should not become a more widespread visualisation tool, since they offer significant advantages.  
